"""initial_restructured_schema

Revision ID: bf73c3c1bfb3
Revises: 
Create Date: 2026-06-29 11:45:45.434721
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_organizations_school_email'), 'organizations', ['school_email'], unique=True)
    ...
    sa.Column('role', sa.Enum('STAFF', 'BURSAR', name='userrole'), nullable=True),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_organizations_school_email'), table_name='organizations')
