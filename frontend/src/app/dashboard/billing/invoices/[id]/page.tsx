...
import type { FeeTemplate, InvoiceLineItem } from "@/src/features/dashboard/billing/types/billing.types";
  ...
  return (
    <main className="min-h-screen bg-background px-6 py-8 md:px-10 lg:px-16">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <header className="rounded-2xl border border-border/80 bg-card p-6 shadow-sm">
          <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <h1 className="mt-2 font-headline text-3xl text-on-surface">Invoice details</h1>
              <p className="mt-3 text-sm text-on-surface-variant">Review the invoice breakdown, add optional charges, or void the statement.</p>
            </div>
        ...
        {isLoading ? (
          <div className="rounded-2xl border border-border/80 bg-card p-6 shadow-sm text-sm text-on-surface-variant">
